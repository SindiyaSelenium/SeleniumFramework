...
public class WriteExcel 
{
	...
	static String filename = ".//InputSheets//UserNamePassword.xlsx";
	static String sheetname = "Sheet1";
			
	public static String[][]getData(String filename, String sheetname, String column_name)
	{
		try
		{
			...
			Reporter.log("Read the data and printed the value.");
			return data;
		}
		catch(Exception e)
		{
			Reporter.log("Unbale to read excel file. "+e);
			return null;
		}
	}
}
